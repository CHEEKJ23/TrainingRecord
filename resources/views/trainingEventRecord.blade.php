...
<div class="container" style="background-color: #fff; margin-top:5%; border-radius:15px;">
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <p>File: 
                @if ($event->eveFile)
                    <a class="btn btn-success" href="{{ asset($event->eveFile) }}" target="_blank"><i class="fa-regular fa-file"></i> {{ $event->eveFile }}</a> |
                    <a class="btn btn-secondary" href="{{ asset($event->eveFile) }}" download><i class="fa-regular fa-circle-down"></i> Download File</a>
                @else
                    No File Available
                @endif
                </p>
